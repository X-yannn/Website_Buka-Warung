...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="index.php">Hans Bakery</a></h1>
			<ul>
	...
	<div class="section">
		<div class="container">
			  <!-- Tombol Back -->
            <a href="produk.php" class="btn-back" style="display:inline-block;margin-bottom:15px;padding:8px 16px;background:#eee;color:#333;text-decoration:none;border-radius:4px;">&larr; Kembali</a>
			<h3>Detail Produk</h3>
			<div class="box">
				<div class="col-2">
